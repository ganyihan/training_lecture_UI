...
export default function show() {
    ...
    var data1 = [-1746181, -1084488, -2089758, -2222362, -2537431, -1746181, -188428, -2089758, -2222362, -2537431,
    -1746181, -1884428, -289758, -2222362, -2537431, -176181];
    var data2 = [1656154, 1787564, 2981671, 2108575, 2403438, 1656154, 1787564, 1981671, 108575, 2403438,
        1656154, 1787564, 1981671, 2108575, 243438, 1656154,];
    var data3 = [];
    ...
    Highcharts.chart('container', {
        ...
        tooltip: {
            formatter: function () {
                return '<b>' + this.series.name + ', 股票： ' + this.point.category + '</b><br/>' +
